    ...
    if (userData) {
      ...
      if (match) {
        ...
        return res.status(200).json({
          ...
          data: { token: token, patientId: userData._id },
        });
      }
    }

    // If the credentials are incorrect or the patient doesn't exist, return an error message
